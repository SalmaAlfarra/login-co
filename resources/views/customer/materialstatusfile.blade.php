    ...
    <div class="card card-custom card-stretch">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">إضافة بيانات الحالة الاجتماعية للزبائن من ملف إكسل </h3>
            </div>
        </div>
        <!--begin::Form-->
        <form action="{{route('customer.materialstatusexcel')}} " method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
